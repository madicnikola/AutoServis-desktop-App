 ...
 * @author Nikola
 */
public class SOStornirajRacunTest extends OpstaSOTest {

    public SOStornirajRacunTest() {
    }
    ...
    public void setUp() {
        try {
            ...
            ((Racun) odo).setStorniran(true);
            so = new SOStornirajRacun((Racun) odo);
    ...
    /**
     * Test of izvrsiOperaciju method, of class SOStornirajRacun.
     */
    @Test
    @Override
    public void testIzvrsiOperaciju() throws Exception {
        super.testIzvrsiOperaciju();
        Racun expResult = (Racun) odo;
        Racun result = (Racun) so.getOpstiDomenskiObjekat();
        assertTrue(result.isStorniran() == expResult.isStorniran());
    }
